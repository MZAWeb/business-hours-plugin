...
if ( !class_exists( "MZASettings" ) ) {
	...
	class MZASettings {
		...
		public function settings_submenu() {
			$this->page = add_submenu_page( $this->location, $this->settingsPageTitle, $this->settingsLinkTitle, 'manage_options', $this->owner . '-settings', array( $this,
			                                                                                                                                                          'settings_page' ) );
		...
		public function settings_page() {
			...
			$this->builder = new MZAFormBuilderForSettings( $name, $this->settingsPageTitle, $this->sections, array( $this,
			                                                                                                         "update_sections" ) );
